...
### the script expects a parallel environment, 40 threads are launched
...
inputFileDir='/proj/omics4tb/alomana/projects/rossSea/data/sortedCells/diamond/'
threshold=70.
threads=4 # it's per file, we have only 4 files
